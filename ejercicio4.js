function PeliculasEN(){
    peliculas.forEach(function(pelicula) {
        for (const property in pelicula) {
            var titulo;
            var lenguaje;
            if (property == 'title'){
                titulo = pelicula[property];
            }
            if (pelicula[property] == 'en'){
                lenguaje = pelicula[property];
            }
        }
        if (lenguaje == 'en'){
            console.log(titulo+" - "+lenguaje);
        }
    })
}
